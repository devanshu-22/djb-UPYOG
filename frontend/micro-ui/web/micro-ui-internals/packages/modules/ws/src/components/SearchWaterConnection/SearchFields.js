...
import { TextInput, SubmitBar, SearchField, MobileNumber } from "@djb25/digit-ui-react-components";

const SearchFields = ({ register, control, reset, tenantId, t, hideSubmitButton = false }) => {
