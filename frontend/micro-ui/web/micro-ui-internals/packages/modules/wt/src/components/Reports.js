...
import { TextInput, SubmitBar, DatePicker, CardLabelError, Table, MobileNumber, Loader } from "@djb25/digit-ui-react-components";
import { Link } from "react-router-dom";
import { APPLICATION_PATH } from "../utils";
import CollapsibleCardPage from "./CollapseCard";

const Reports = ({ isLoading = false, t, onSubmit = () => {}, data = null, count = 0, setShowToast = false }) => {
